{
  ...
  outputs = { self, nixpkgs }:
    let
      ...
      gitRevision = "e7f350951b304f0426832b0b6482c8bedf239c23";
      gitSha256 = "sha256-74kk4VXAiFemdU3isy+6qFLAuYjSfPdSG6wmUOKWD6c=";
      ...
      overlay = final: prev: {
        mlir = with final; llvmPackages_16.stdenv.mkDerivation {
          ...
          cmakeFlags = [
            ...
            "-DLLVM_ENABLE_PROJECTS=mlir;clang;openmp;clang-tools-extra;compiler-rt"
